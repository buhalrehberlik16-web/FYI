window.LANG_TR = {
        ...
        skills: {
            ...
            slash: { name: "Kesik", desc: "Saldırı gücü + %25 Str bonusu. 20 Öfke harcar." },
            reckless_strike: { name: "Pervasız Vuruş", desc: "Hasar: <b style='color:orange'> 1.5 x ATK kadar hasar. 35 Öfke Harcar </b>.<br><span style='color:#ff4d4d'>2 Tur: Defansın 0 olur.</span>" },
            wind_up: { name: "Kurulma", desc: "Sonraki saldırın <b style='color:orange'>+1 x STR</b> fazla vurur. +15 Rage kazandırır." },
            bash: { name: "Balyoz", desc: "Hasar: <b style='color:orange'>ATK + 0.4 x STR</b>.<br><span style='color:cyan'>%30 Şansla Sersemletir (1 Tur).</span>" },
            pierce_through: { name: "Delip Geç", desc: "Hasar: <b style='color:orange'>1.25 x ATK + 0.4 x STR</b>.<br><span style='color:cyan'>Düşman Defansının %50'sini yok sayar.</span>" },
            ...
            Pommel_Bash: { name: "Kabzayla Vur", desc: "Str'nin %100'ü kadar hasar. +12 Rage üretir." },
