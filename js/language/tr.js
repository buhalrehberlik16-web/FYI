window.LANG_TR = {
		...
		enemy_skills: {
			...
			vaga_rush: { name: "HÜCUM" },
			roar: { name: "KÜKREME" },
			thorn_prick: { name: "Diken Batması" },
			thorn_scratch: { name : "Çalı Kesiği" , effect: "KANAMA" },
			lizard_tail: { name: "KUYRUK DARBESİ" },
			...
			arrow_rain: { name: "OK YAĞMURU", effect: "ZEHİR" },
			curse_bomb: { name: "Katran Bombası"},
        ...
        skills: {
            ...
            guard: { name: "Siper", desc: "2 Tur boyunca alınan hasarı <span style='color:#43FF64'>0.25 x INT</span> kadar azaltır.<br><span style='color:cyan'>-10 Öfke.</span>", log: "Gelen hasar $1 azalacak." },
