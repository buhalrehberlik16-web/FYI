window.LANG_TR = {
		...
		combat: {
			...
			log_exhaust_50: "😓 **Yorgunluk**: Hareketlerin ağırlaştı. Defans -3 ve toplam güç %10 azaldı.",
			log_exhaust_60: "😓 **Yorgunluk**: Nefes alışın zorlaşıyor. Defans -4.",
			log_exhaust_70: "😫 **Yorgunluk**: Ciğerlerin yanıyor! Defans -5 ve toplam güç %20 azaldı.",
			log_exhaust_80: "😫 **Yorgunluk**: Kasların titremeye başladı. Defans -6.",
			log_exhaust_90: "😫 **Yorgunluk**: Görüşün bulanıklaşıyor. Defans -7.",
			log_exhaust_100: "😱 **Tükeniş**: Limitlerini aştın! Atak gücü düşmeye başladı ve artık her tur Can kaybedeceksin.",
			log_exhaust_crit: "😱 **Tükeniş**: Ölümün kıyısındasın! (Atak Kaybı Artıyor)",
