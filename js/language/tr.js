window.LANG_TR = {
        ...
        skills: {
			...
			blood_mark: { name: "Kan Damgası", desc: "Oda boyunca karanlık bir bağ kurar.<br><span style='color:#ff4d4d'>Tüm dirençlerin sıfıra düşer.</span><br><span style='color:#43FF64'>Tüm saldırılarından %20 can çalarsın.<br>(7. Turdan itibaren her tur %1 azalır.)</span><br><span style='color:#ffd700'>Zaferde: Toplam çalınan canın %20'si kadar Kalıcı Max HP kazanırsın.</span><br><span style='color:cyan'>-30 Öfke.</span>" },
