window.LANG_TR = {
        ...
        skills: {
            ...
            slash: { name: "Kesik", desc: "Hasar: <b style='color:orange'>ATK + 0.25 Str bonus.</b><br><span style='color:cyan'>-20 Öfke.</span>" },
            reckless_strike: { name: "Pervasız Vuruş", desc: "Hasar: <b style='color:orange'> 1.5 x ATK kadar hasar.</b>.<br><span style='color:#b19cd9'>2 Tur: Defansın 0 olur.</span><br><span style='color:cyan'>-35 Öfke.</span>" },
			...
			light_blade: { name: "Işığın Kılıcı", desc: "Cesur saldırı.<br>Hasar: <b style='color:orange'>1 x ATK + 1 x MP</b>.<br><span style='color:cyan'>-35 Öfke.</span>" },
