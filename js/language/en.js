...
// Upper Bar & Nav
        ...
        skills: {
            ...
            minor_healing: { name: "Minor Healing", desc: "Quick bandage.<br><span style='color:#43FF64'>Flat 10 HP</span> + (0.5 x INT).<br><span style='color:cyan'>-20 Rage.</span>" },
            distract: { name: "Distract", desc: "<b style='color:green'>(Fast Action)</b><br>Enemy ATK reduced by 25% (1 Turn).<br>Enemy DEF reduced by 50% (2 Turns).<br><span style='color:cyan'>-50 Rage.</span>" },
            ...
            sharpen: { name: "Sharpen", desc: "<span style='color:#43FF64'>4 Turns: +25% Attack Power</span>.<br><span style='color:cyan'>-30 Rage.</span>" },
			...
			provoke: { name: "Provoke", desc: "Psychological warfare.<br><b style='color:#43FF64'>(Fast Action)</b><br><span style='color:#43FF64'>Forces enemy intention to Attack.</span><br><span style='color:#43FF64'>2 Turns: Gain Regeneration equal to INT.</span><br><span style='color:#b19cd9'>Enemy gains Attack equal to 25% of their Defense.</span><br><span style='color:cyan'>-20 Rage.</span>" },
