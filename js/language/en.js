...
// Upper Bar & Nav
        ...
        skills: {
            ...
            slash: { name: "Slash", desc: "Attack Power + 25% Str bonus. Costs 20 Rage." },
            reckless_strike: { name: "Reckless Strike", desc: "Damage: <b style='color:orange'>1.5 x ATK</b>.<br><span style='color:#ff4d4d'>2 Turns: Your Defense becomes 0.</span>" },
            ...
            pierce_through: { name: "Pierce Through", desc: "Damage: <b style='color:orange'>1.25 x ATK + 0.4 x STR</b>.<br><span style='color:cyan'>Ignores 50% of Enemy Defense.</span>" },
            ...
            Pommel_Bash: { name: "Pommel Bash", desc: "Deals 100% of Strength as damage. Generates +12 Rage." },
