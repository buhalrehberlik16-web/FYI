...
// Upper Bar & Nav
	...
	codex: {
        ...
        skills: {
            ...
            blood_price: { name: "Blood Price", desc: "<span style='color:green'>(Fast Action)</span><br><b style='color:#ff4d4d'>Sacrifice 15% of Max HP</b><span style='color:cyan'> to gain equal amount of Rage.</span>", log: "Sacrificed $1 HP, gained $2 Rage." },
			...
			Fire_Bolt: { name: "Fire Bolt", desc: "Hasar: <b style='color:orange'>0.5xATK+ 0.5xSTR (Phys) + 0.5xMP (Fire)</b>.<br><span style='color:cyan'>-20 Mana.</span>" },
			Zap: { name: "Zap", desc: "Hasar: <b style='color:orange'>1.1xINT (Lightning)</b>.<br><span style='color:#b19cd9'>3 Turns: Enemy Attack reduced by 20%.</span><br><span style='color:cyan'>-25 Mana.</span>" },
			Ignite: { name: "Ignite", desc: "Deals Str damage and <b style='color:orange'> 0.5xMP Fire </b> damage each turn for 3 Turns."},
			...
			Strangle: { name: "Strangle", desc: "Deals Int damage and <b style='color:orange'> 0.8xInt Poison </b> damage each turn for 3 turns."},
