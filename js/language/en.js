...
// Upper Bar & Nav
	...
	codex: {
        ...
        skills: {
			...
			// BARBARIAN SKILLS //
			// MAGUS SKILLS //
			Fireball: { name: "Fireball", desc: "Damage: <b style='color:orange'>0.5xATK + 0.5xMP</b>.<br>3 Turns:<b style='color:orange'>DoT: 0.4xMP(Fire) + 0.2xINT(Curse)</br><br><span style='color:cyan'>-15 Mana.</span>" },
