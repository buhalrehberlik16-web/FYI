...
// Upper Bar & Nav
	...
	codex: {
        ...
        skills: {
			...
			Mana_Blast: { name: "Mana Blast", desc: "Damage: <b style='color:orange'>1.4xMP (Physical)</b>.<br>3 Turns:<span style='color:#b19cd9'>Enemy Attack reduced by 20%.</span><br><span style='color:cyan'>-20 Mana.</span>" },
