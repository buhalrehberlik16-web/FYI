...
// Upper Bar & Nav
	...
	codex: {
		...
		enemy_skills: {
			...
			thorn_scratch: { name : "THORN SCRATCH" , effect: "BLEED" },
			lizard_tail: { name: "LIZARD TAIL" },
			...
			arrow_rain: { name: "ARROW RAIN", effect: "POISON" },
			curse_bomb: { name: "TAR BOMB"},
        ...
        skills: {
            ...
            guard: { name: "Guard", desc: "Reduces incoming damage by <span style='color:#43FF64'>0.25 x INT</span> for 2 turns.<br><span style='color:cyan'>-10 Rage.</span>", log: "Incoming damage reduced by $1." },
