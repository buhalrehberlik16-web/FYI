const ENEMY_STATS = {
    // --- TIER 1 ---
    "Zehirli Mantar": { 
        maxHp: 40, attack: 10, defense: 0, xp: 0, // XP artık dinamik hesaplanacak, buradaki 0 önemsiz
        tier: 1, // YENİ EKLENDİ
    ...
    "Orman Örümceği": { 
        maxHp: 65, attack: 22, defense: 2, xp: 0, 
        tier: 1, // YENİ
    ...
    "Hırsız Kobold": { 
        maxHp: 55, attack: 12, defense: 1, xp: 0, 
        tier: 1, // YENİ
    ...
    "Kan Yarasası": { 
        maxHp: 45, attack: 14, defense: 0, xp: 0, 
        tier: 1, // YENİ
    ...
    // --- TIER 2 ---
    "Goblin Devriyesi": { 
        maxHp: 90, attack: 15, defense: 5, xp: 0, 
        tier: 2, // YENİ
    ...
    "Kaçak Haydut": { 
        maxHp: 110, attack: 18, defense: 6, xp: 0, 
        tier: 2, // YENİ
    ...
    "Gri Kurt": { 
        maxHp: 100, attack: 25, defense: 3, xp: 0, 
        tier: 2, // YENİ
    ...
    // --- TIER 3 ---
    "Yaban Domuzu": { 
        maxHp: 160, attack: 20, defense: 8, xp: 0, 
        tier: 3, // YENİ
    ...
    "Goblin Savaşçısı": { 
        maxHp: 150, attack: 22, defense: 12, xp: 0, 
        tier: 3, // YENİ
    ...
    "Kaya Golemi": { 
        maxHp: 180, attack: 14, defense: 8, xp: 0, 
        tier: 3, // YENİ
    ...
    // --- TIER 4 ---
    "Orc Fedaisi": { 
        maxHp: 240, attack: 30, defense: 10, xp: 0, 
        tier: 4, // YENİ
    ...
    // --- BOSS ---
    "Goblin Şefi": { 
        maxHp: 450, attack: 28, defense: 10, xp: 0, 
